            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  color: Colors.green,
                  child: Center(
                    child: Text("Taxi is needed for:", style: TextStyle(fontSize: wid>500?12.sp:24.sp, color: Colors.white, fontWeight: FontWeight.bold),),
                  ),
                ),
                Column(
                  children: [
                    ...
                    Column(
                      children: [
                        Text("Name", style: TextStyle(color: Colors.white, fontSize: wid>500?10.sp:20.sp,),),
                    ...
                    Column(
                      children: [
                        Text("Location", style: TextStyle(color: Colors.white, fontSize: wid>500?10.sp:20.sp,),),
