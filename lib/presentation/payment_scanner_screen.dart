...
class _PaymentScannerScreenState extends State<PaymentScannerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List lChanger;
    return Consumer3<LanguageChanger, GetPayment, GetPaymentStatus>(
          builder: (_, languageChanger, getPayment, getPaymentStatus, __) {
                          ...
                          child: Column(
                            ...
                            children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text("You", style: TextStyle(fontSize: 20, color: Colors.black),),
                                        ],
                                      ),
                                    ),
                                                      SizedBox(height: 5,),
                                                      Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          ...
                                                          child: Icon(Icons.arrow_forward_rounded, color: cTheme.primaryColorDark)),
                                                      SizedBox(height: 5,),
                                    Expanded(
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        ...
                                        children: [
                                          ...
                                          Text("MRF", style: TextStyle(fontSize: 20, color: Colors.black),),
                                        ],
                                      ),
                                    ),
                              ...
                              MainBtn(wid>600?wid*0.4:wid-40, wid>600?62.0:72.0, cTheme.primaryColor, lChanger[8]["btn"], () async {
                                // Navigator.of(context).pop();
                                await getPaymentStatus.getPaymentStatus(getPayment.createPaymentResponse!.paymentId);
                                showDialog(
                                    context: context,
