                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Text("Settings".toUpperCase(), style: TextStyle(fontSize: wid>600?12.sp:24.sp, color: Colors.grey,),),
                                    SizedBox(
                                    ...
                                    Row(
                                      ...
                                      children: List.generate(3, (index){
                                        return Container(
                                          width: wid>600?30.sp:80.sp,
                                          height: wid>600?30.sp:80.sp,
                ...
                Flex(
                  ...
                  children: [
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text("VIEW YOUR AREA", style: TextStyle(color: Colors.white, fontSize: wid>600?10.sp:24.sp),),
                              ],
                            ),
                          ),
                        ),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          threeBtns(2000, wid>600?hei4/3-20:(hei4/4).sp, cTheme.primaryColorLight, null, EdgeInsets.only(left: wid>600?10.sp:30.sp, right: 15.sp),
                            Flex(
                              ...
                              children: [
                                Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text("Your community".toUpperCase(), style: TextStyle(fontSize: wid>600?6.sp:20.sp, fontWeight: FontWeight.bold, color: cTheme.primaryColorDark),),
                                    Text("Find out what is new in your community", style: TextStyle(fontSize: wid>600?4.sp:14.sp, color: Colors.grey),),
                                  ],
                                ),
                                // wid>500?Container(
                                //   width: ((hei*0.6)/2),
                          ...
                          threeBtns(2000, wid>600?hei4/3-20:(hei4/2-60).sp, cTheme.primaryColorLight, null, EdgeInsets.only(left: wid>600?10.sp:30.sp, right: wid>600?10:0),
                            Flex(
                              direction: wid>600?Axis.horizontal:Axis.vertical,
                              ...
                              children: [
                                Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text("Whatever you need".toUpperCase(), style: TextStyle(fontSize: wid>600?6.sp:20.sp, fontWeight: FontWeight.bold, color: cTheme.primaryColorDark),),
                                    Text("Support, Taxi, Fixation and more", style: TextStyle(fontSize: wid>600?4.sp:14.sp, color: Colors.grey),),
                                  ],
                                ),
                                SizedBox(
                                  height: 20,
                          ...
                          threeBtns(2000, wid>600?hei4/3-20:(hei4/4).sp, cTheme.primaryColor, LinearGradient(
                            ...
                            Center(
                                child: Text(wid>600?"Some Large Heading Here".toUpperCase():"Some Large\nHeading Here".toUpperCase(), style: TextStyle(fontWeight: FontWeight.bold, fontSize: wid>600?10.sp:20.sp, color: Colors.white, ), textAlign: TextAlign.center,),
                            ),(){
